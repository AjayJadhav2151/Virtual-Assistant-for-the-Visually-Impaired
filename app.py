...
def login():
    if request.method == 'POST':
        ...
        if user and check_password_hash(user.pass1, pass1):
            ...
            flash('Login failed. Check your Phone NO and password.', 'danger')
    ...
    if request.method == 'POST':
        if request.form.get('Start') == 'Start':
            ...
            while True:
                ...
                cv2.imshow('Virtual Assistance for the Visually Impaired', img)
